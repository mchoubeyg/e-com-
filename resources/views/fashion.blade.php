...
<div class="container">
    <div class="row">
    <h2 class="text-light">T-Shirts</h2>
...
<div class="container">
    <div class="row">
    <h2 class="text-light">Kids Cloths</h2>
    <div class="owl-carousel mobile-carousel owl-theme text-success">
...
<div class="py-2">
    <div class="container">
        <div class="row">
            <h2 class="text-light">Wedding</h2>
            <div class="owl-carousel mobile-carousel owl-theme text-success">
